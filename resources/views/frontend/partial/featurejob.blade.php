							...
							<div class="card-body">
								...
								<div class="item-card7-text">
									<ul class="icon-card mb-0">
										...
										<li class="mb-0"><a href="#" class="icons"><i class="si si-briefcase text-muted mr-1"></i> Hardware Solutions</a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								...
								<div class="item-card7-text">
									<ul class="icon-card mb-0">
										...
										<li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 5 hours ago</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-user text-muted mr-1"></i> Sally Peake</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-briefcase text-muted mr-1"></i>Flowtech Solutions</a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								...
								<div class="item-card7-text">
									<ul class="icon-card mb-0">
										...
										<li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 5 hours ago</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-user text-muted mr-1"></i> Sally Peake</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-briefcase text-muted mr-1"></i>IT Solutions</a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								...
								<div class="item-card7-text">
									<ul class="icon-card mb-0">
										...
										<li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 5 hours ago</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-user text-muted mr-1"></i> Sally Peake</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-briefcase text-muted mr-1"></i> Pinlist</a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								...
								<div class="item-card7-text">
									<ul class="icon-card mb-0">
										...
										<li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 5 hours ago</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-user text-muted mr-1"></i> Sally Peake</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-briefcase text-muted mr-1"></i> Infratech Pvt Ltd </a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								...
								<div class="item-card7-text">
									<ul class="icon-card mb-0">
										...
										<li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 5 hours ago</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-user text-muted mr-1"></i> Sally Peake</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-briefcase text-muted mr-1"></i>Genius Technicals</a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								...
								<div class="item-card7-text">
									<ul class="icon-card mb-0">
										...
										<li><a href="#" class="icons"><i class="si si-event text-muted mr-1"></i> 5 hours ago</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-user text-muted mr-1"></i> Sally Peake</a></li>
										<li class="mb-0"><a href="#" class="icons"><i class="si si-briefcase text-muted mr-1"></i> Kids Play School</a></li>
									</ul>
								</div>
							</div>
						</div>
